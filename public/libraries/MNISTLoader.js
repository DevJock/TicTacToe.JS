function loadMNIST(callback) {
    let mnist = {};
    let files = {
      train_images: '../Resources/train-images-idx3-ubyte',
      train_labels: '../Resources/train-labels-idx1-ubyte',
      test_images: '../Resources/t10k-images-idx3-ubyte',
      test_labels: '../Resources/t10k-labels-idx1-ubyte',
    };
